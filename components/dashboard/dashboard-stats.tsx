...
import { getReservationStats } from "@/lib/data"
    ...
    <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
      <Card>
        ...
        <CardContent>
          ...
          <p className="text-xs text-muted-foreground">
            {stats.todayReservationsChange > 0 ? "+" : ""}
            {stats.todayReservationsChange}% from last week
          </p>
        </CardContent>
      </Card>
      ...
      <Card>
        ...
        <CardContent>
          ...
          <p className="text-xs text-muted-foreground">{stats.totalTables} total tables</p>
        </CardContent>
      </Card>
      ...
      <Card>
        ...
        <CardContent>
          <div className="text-2xl font-bold">{stats.expectedGuests}</div>
          <p className="text-xs text-muted-foreground">
            {stats.expectedGuestsChange > 0 ? "+" : ""}
            {stats.expectedGuestsChange}% from yesterday
          </p>
        </CardContent>
      </Card>
      ...
      <Card>
        ...
        <CardContent>
          ...
          <p className="text-xs text-muted-foreground">{stats.vipGuestsPercentage}% of total guests</p>
        </CardContent>
      </Card>
    </div>
  )
